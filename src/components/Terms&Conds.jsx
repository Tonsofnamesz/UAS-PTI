...
const TermsandConds = () => {
  return (
    ...
    <div className="TermsStuff">
      ...
      <h2>OVERVIEW</h2>
      <p>
      This website is operated by INVENIRE GRIFFON. Throughout the site, the
      terms “we,” “us,” and “our” refer to INVENIRE GRIFFON. INVENIRE GRIFFON
      ...
      not limited to copyright laws). You must not transmit any worms or viruses or 
      ...
      any portion of the Service, use of the Service, or access to the Service or any 
      ...
      on this site is at your own risk. This site may contain certain historical information. 
      ...
      any time, but we have no obligation to update any information on our site. You 
      ...
      to you or to any third-party for any modification, price change, suspension 
      ...
      or distributors. You agree to provide current, complete and accurate purchase and 
      account information for all purchases made at our store. You agree to promptly update 
      your account and other information, including your email address and credit card numbers 
      ...
      nor have any control nor input. You acknowledge and agree that we provide access 
      to such tools ”as is” and “as available” without any warranties, representations 
      ...
      or without a request from us you send creative ideas, suggestions, proposals, 
      ...
      that you forward to us. We are and shall be under no obligation (1) to maintain any 
      comments in confidence; (2) to pay compensation for any comments; or (3) to respond 
      ...
      any party’s intellectual property or these Terms of Service. You agree that your 
      ...
      Service or on any related website, should be taken to indicate that all information 
      ...
      laws, or local ordinances; (d) to infringe upon or violate our intellectual property 
      ...
      Service or any related website, other websites, or the Internet. We reserve the right 
      to terminate your use of the Service or any related website for violating any of the 
      prohibited uses.
      </p>
      ...
      time or cancel the service at any time, without notice to you. You expressly agree 
      ...
      durability, title, and non-infringement. In no case shall INVENIRE GRIFFON, our directors, 
      ...
      <p>
      You agree to indemnify, defend and hold harmless to INVENIRE GRIFFON and our parent, 
      ...
      to The Service constitutes the entire agreement and understanding between you and 
      ...
      <h2>SECTION 20 - CONTACT OF INFORMATION</h2>
      <p>
